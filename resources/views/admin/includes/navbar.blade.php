    ...
    <div class="container-fluid"> <!--begin::Start Navbar Links-->
        ...
        <ul class="navbar-nav ms-auto"> <!--begin::Navbar Search-->
                ...
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end"> <a href="#" class="dropdown-item">
                        ...
                        <div class="d-flex">
                            <div class="flex-shrink-0"> <img
                                    src="{{ Vite::asset('resources/assets/img/user1-128x128.jpg') }}" alt="User Avatar"
            ...
            <li class="nav-item dropdown user-menu"> <a href="#" class="nav-link dropdown-toggle"
                    data-bs-toggle="dropdown"> <img src="{{ Vite::asset('resources/assets/img/user2-160x160.jpg') }}"
                        class="user-image rounded-circle shadow" alt="User Image"> </a>
                <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end"> <!--begin::User Image-->
                    <li
                        class="user-header text-bg-primary d-flex flex-column justify-content-center align-items-center">
                    ...
                    <li class="user-footer d-flex justify-content-center align-items-center">
                        <a href="#" class="btn btn-info btn-flat mr-2">Profile</a>
                        {{-- <a href="{{ route('logout') }}" class="btn btn-default btn-flat float-end">Sign out</a> --}}
                        <form action="{{ route('logout') }}" method="POST">
                            @csrf
                            <button type="submit" class=" btn btn-warning btn-flat float-end">Signout</button>
                        </form>
                    </li>
                    <!--end::Menu Footer-->
                </ul>
